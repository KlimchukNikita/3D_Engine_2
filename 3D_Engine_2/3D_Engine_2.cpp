// 3D_Engine_2.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int nMapWidth = 16;			   	        // Размер окружения
int nMapHeight = 16;
...
float fDepth = 16.0f;			        // Максимальное расстояние отрисовки
